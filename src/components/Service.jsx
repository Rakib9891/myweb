...
function Service() {
  const services = [
    {
      ...
      description:
        "Responsive, fast, and modern web interfaces built using HTML, CSS, JavaScript, and React.",
      icon: <FaCode size={30} className="text-green-400" />,
    },
    {
      title: "React UI Components",
      description:
        "Reusable UI components like forms, modals, and navbars built with React & Tailwind CSS.",
      icon: <FaReact size={30} className="text-sky-400" />,
    },
    {
      title: "Website Optimization",
      description:
        "Boost site performance, fix bugs, and ensure mobile responsiveness across devices.",
  ...
  return (
    <section
      className="py-16 px-6 bg-[#f8f9fa] dark:bg-[#0f172a] text-[#332E2E] dark:text-white"
      id="services"
    >
